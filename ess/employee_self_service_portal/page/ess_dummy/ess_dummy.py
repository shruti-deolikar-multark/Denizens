...
def get_employee_details(employee):
    ...
    # format dates
        ...
        emp_details.education = frappe.get_all(
            "Employee Education",
            filters={"parent": employee},
            fields=["qualification", "school_univ", "year_of_passing", "level"],
        )
...
def get_employee_data(employee_name):
    ...
    # Fetch the main Employee document
    employee = frappe.get_doc("Employee", employee_name)

    # Fetch education details (child table)
    education_details = frappe.get_all(
        "Employee Education",
